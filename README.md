...
Everything in this repo was generated by Claude Code using the Sonnet 4.6 model. This single paragraph of README.md is the only
...
it's still an LLM generating points for a set of bezier curves, which for some reason is wild to me (even more so that AI agents generally).
